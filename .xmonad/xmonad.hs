...
myKeys =
    ...
    -- Grid Select
        , ("M-S-t", spawnSelected' myAppGrid)                 -- grid select favorite apps , ("M-S-g", goToSelected $ mygridConfig myColorizer)  -- goto selected
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/tariq/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/tariq/.config/xmobar/xmobarrc2"
    xmproc2 <- spawnPipe "xmobar -x 2 /home/tariq/.config/xmobar/xmobarrc1"
